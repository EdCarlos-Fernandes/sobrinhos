<?php
    ...
    if ($redirecionar) {
        ...
        if (isset($_SESSION['numLogin']) && isset($_SESSION['username'])) {
            ...
            $redirectUrl = "$url/paginas/sobre.php?num=$numLogin&id=$username";
...
<head>
    ...
    <title><?php echo $titulo ?> - SOBRE</title>
    <?php 
...
<body>
    ...
    <main class="container-fluid page-body-wrapper d-flex flex-column">
